...
industries = ['통신업', '의료정밀', '운수창고업', '의약품', '음식료품', '전기가스업', '서비스업', '전기전자', '종이목재', '증권']
...
# 수직 방향
# pos = np.arange(10)
# rects = plt.bar(pos, fluctuations, align='center', width=0.5, color='royalblue')
# plt.xticks(pos, industries)
#
# for i, rect in enumerate(rects):
